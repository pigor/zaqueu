...
Mais informações visite: http://idopter.com/users/paulo-igor/ideas/186-cobrador-online

== Próximas Funcionalidades
- Criar validação para data
- Disparar cobranças automáticas
- Agendar cobranças periódicas